    ...
    public static class EntityMetadataTypeUtil
    {
        ...
        public static EntityMetadataType FromSerializedTypeName(string typeName)
        {
            return typeName switch {
                ...
                "rotations"             => EntityMetadataType.Rotations,
                ...
                "optional_living_entity_reference" => EntityMetadataType.OptionalUUID,
                "block_state"           => EntityMetadataType.BlockState,
                "optional_block_state"  => EntityMetadataType.OptionalBlockState,
        ...
        public static Type GetType(EntityMetadataType dataType)
        {
            return dataType switch {
                ...
                EntityMetadataType.Rotations               => typeof (Vector3),
                ...
                EntityMetadataType.BlockState                => typeof (int),
                EntityMetadataType.OptionalBlockState        => typeof (int),
