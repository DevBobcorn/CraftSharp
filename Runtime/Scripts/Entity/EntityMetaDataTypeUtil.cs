    ...
    public static class EntityMetaDataTypeUtil
    {
        ...
        public static Type GetType(object value, EntityMetaDataType dataType)
        {
            return dataType switch {
                ...
                EntityMetaDataType.OptionalPosition       => typeof (Nullable<Location>),
                EntityMetaDataType.Direction              => typeof (int),
                EntityMetaDataType.OptionalUuid           => typeof (Nullable<Guid>),
                ...
                EntityMetaDataType.OptionalVarInt         => typeof (Nullable<int>),
