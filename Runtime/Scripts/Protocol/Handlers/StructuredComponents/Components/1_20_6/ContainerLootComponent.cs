...
{
    public record ContainerLootComponent : StructuredComponent
    {
        public Dictionary<string, object>? Nbt { get; set; }

        public ContainerLootComponent(ItemPalette itemPalette, SubComponentRegistry subComponentRegistry) 
