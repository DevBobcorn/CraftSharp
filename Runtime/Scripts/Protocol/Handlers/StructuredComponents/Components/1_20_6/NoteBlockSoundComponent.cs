...
{
    public record NoteBlockSoundComponent : StructuredComponent
    {
        public string Identifier { get; set; } = null!;

        public NoteBlockSoundComponent(ItemPalette itemPalette, SubComponentRegistry subComponentRegistry) 
