...
{
    public record DebugStickStateComponent : StructuredComponent
    {
        public Dictionary<string, object>? Nbt { get; set; }

        public DebugStickStateComponent(ItemPalette itemPalette, SubComponentRegistry subComponentRegistry) 
